...
import AuthRoutes from "./server/authRoute.js";
...
const URL =
  "mongodb+srv://User:One23456@curdd.kz1mu.mongodb.net/CURD?retryWrites=true&w=majority";
// `mongodb+srv://${process.env.USERNAME}:${process.env.PASSWORD}@curdd.kz1mu.mongodb.net/CURD?retryWrites=true&w=majority`;
